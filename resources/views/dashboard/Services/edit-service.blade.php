            ...
            <div class="card shadow h-50 py-2">
                <div class="d-flex justify-content-between">
                    <div class="card-title mx-4 mb-5 mt-2">
                        <h3 class="text-dark text-uppercase fw-bold">Add a Service</h3>
                    </div>
    ...
    <div class="row">
        <div class="col-xl-12 col-md-12 mb-2">
            <div class="card">
                ...
                @endif
                <form action="{{ route('edit-Service.edit', ['id' => $service->id]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method("PUT")
                    <div class="row mx-3 mb-3 mt-3">
                        <div class="col-xl-12 col-md-12">
                            <label for="" class="mb-3">Service Category</label>
                    ...
                    <div class="row mx-3 mb-3 mt-3">
                        <div class="col-xl-12 col-md-12">
                            ...
                            <input type="text" name="name" value="{{$service->name}}" class="form-control" style="width: 100%">
                        </div>
                    </div>
                    <div class="row mx-3 mb-3">
                        <div class="col-xl-12 col-md-12">
                            <label for="">Slug</label>
                            <input type="text" name="slug"value="{{$service->slug}}" class="form-control" style="width: 100%">
                        </div>
                    </div>
                    <div class="row mx-3 mb-3">
                        <div class="col-xl-12 col-md-12">
                            <label for="">Description</label>
                            <textarea name="description" id="MySummernote" row="8" class="form-control" style="width: 100%">{!!$service->description!!}</textarea>
                        </div>
                    </div>
                    <div class="row mx-3 mb-3">
                        <div class="col-xl-12 col-md-12">
