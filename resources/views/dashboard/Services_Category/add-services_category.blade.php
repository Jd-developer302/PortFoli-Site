            ...
            <div class="card shadow h-50 py-2">
                <div class="d-flex justify-content-between">
                    <div class="card-title mx-4 mb-5 mt-2">
                        <h3 class="text-dark text-uppercase fw-bold">Add Services Category</h3>
                    </div>
    ...
    <div class="row">
        <div class="col-xl-12 col-md-12 mb-2">
            <div class="card">
                ...
                @endif
                <form action="{{route('add-Services_Category.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
