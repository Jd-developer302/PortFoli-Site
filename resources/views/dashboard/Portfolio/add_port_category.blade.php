            ...
            <div class="card shadow h-50 py-2">
                <div class="d-flex justify-content-between">
                    <div class="card-title mx-4 mb-5 mt-2">
                        <h3 class="text-dark text-uppercase fw-bold">Add a Portfolio Category</h3>
                    </div>
    ...
    <div class="row">
        <div class="col-xl-12 col-md-12 mb-2">
            <div class="card">
                ...
                @endif
                <form action="{{route('add_port_category.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-md-12 mb-4 mt-4">
                            <button class="btn btn-primary mr-3" style="float: right">Save Category</button>
                        </div>
                    </div>
